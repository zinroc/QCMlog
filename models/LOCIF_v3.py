...
TUNED_PARAMS = ["k0", "k1", "n0", "n1", "n2", "dt", "cvert"]
USER_DEFINED_PARAMS = set(["c3", "r", "graph_left_cutoff", "graph_right_cutoff", "optimization_left_cutoff", "optimization_right_cutoff"])
...
def get_saturation_gradient (t, parameters, aux_parameters):
	...
	df_dCvert = 1
	return np.array([df_dk0, df_dk1, df_dN0, df_dN1, df_dN2, df_ddt, df_dCvert])
